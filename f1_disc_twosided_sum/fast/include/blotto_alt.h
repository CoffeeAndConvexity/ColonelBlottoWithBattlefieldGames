...
public:
    ...
    BlottoAlt(int num_battlefields, int max_soldiers_p1, int max_soldiers_p2, BattlefieldLevelGame *battlefield_games, RegretMinimizerEfceFlattenedBase *rm_p1, RegretMinimizerEfceFlattenedBase *rm_p2);
