...
RmPlusEfceFlattened::RmPlusEfceFlattened(unsigned int size)
    : RegretMinimizerEfceFlattenedBase(size)
{
}

RmPlusEfceFlattened::RmPlusEfceFlattened()
...
void RmPlusEfceFlattened::recommend(double *store, bool unused) const
{
    store[0] = 1.0;
...
void RmPlusEfceFlattened::observe_loss(double *loss, double *old_result)
{
...
void RmPlusEfceFlattened::allocate_mem()
{
